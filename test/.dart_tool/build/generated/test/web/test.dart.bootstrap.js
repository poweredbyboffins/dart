...
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'test.digests',
...
define("test.dart.bootstrap", ["web/test", "dart_sdk"], function(app, dart_sdk) {
